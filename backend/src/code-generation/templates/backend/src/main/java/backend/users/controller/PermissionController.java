...
import backend.users.dto.CreatePermissionDto;
import backend.users.dto.UpdatePermissionDto;
import backend.users.entity.PermissionEntity;
import backend.users.service.PermissionService;
...
public class PermissionController {
    ...
    @PostMapping
    public ResponseMessage<PermissionEntity> createPermission(@Valid @RequestBody CreatePermissionDto createPermissionDto) {
    ...
    @PutMapping("/{id}")
    public ResponseMessage<PermissionEntity> updatePermission(@PathVariable UUID id, @Valid @RequestBody UpdatePermissionDto updatePermissionDto) {
