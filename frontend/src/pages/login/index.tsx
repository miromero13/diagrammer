...
const LoginPage = (): JSX.Element => {
  ...
  return (
    <div className='relative isolate grid min-h-[calc(100dvh-4rem)] h-screen w-full place-items-center overflow-hidden bg-muted/30 py-12'>
      ...
      <Card className='relative z-10 w-full max-w-md bg-card/95 shadow-lg backdrop-blur-sm'>
        <CardHeader className='space-y-4'>
          ...
          <div className='space-y-2'>
            ...
            <CardDescription>Accede con tu cuenta para continuar.</CardDescription>
          </div>
        </CardHeader>
        <CardContent>
          <form className='grid gap-4' onSubmit={handleSubmit}>
            ...
            <p className='text-sm text-muted-foreground'>
              ¿No tienes cuenta? <Link className='text-foreground underline' to={PublicRoutes.REGISTER}>Regístrate</Link>
            </p>
          </form>
        </CardContent>
      </Card>
